  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <div className="relative my-1 h-12 w-px flex-1 overflow-hidden bg-line">
          <motion.div
...
function SectionHeading({
  ...
  return (
    <div
      className={`mb-12 ${align === "center" ? "text-center mx-auto max-w-prose2" : "max-w-prose2"}`}
    >
    ...
    <section id="problem" className="relative px-6 py-24 md:px-8 md:py-32">
      <div className="shell grid gap-14 lg:grid-cols-2 lg:gap-20">
        <div>
          ...
          />
          <div className="mt-8 rounded-2xl border border-risk-danger/15 bg-risk-danger/[0.03] p-5">
        ...
        <div className="border-l border-line pl-2 lg:pl-6">
          {PROBLEM.map((s, i) => (
            <StepCard
              key={i}
              step={s}
...
export function SolutionSection() {
  return (
    <section id="technology" className="relative px-6 py-24 md:px-8 md:py-32">
      <div className="shell">
        <SectionHeading
          ...
          align="center"
        />
        <div className="mx-auto mt-4 max-w-2xl border-l border-line pl-2">
          {SOLUTION.map((s, i) => (
            <StepCard
              key={i}
              step={s}
